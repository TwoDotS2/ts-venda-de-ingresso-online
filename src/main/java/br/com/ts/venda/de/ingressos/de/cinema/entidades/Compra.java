...
public class Compra {
    ...
    public Ingresso comprarIngresso(String codigoAssento) throws Exception {

        if(!sessao.assentoEstaDisponivel(codigoAssento)){
            throw new Exception("Assento não está disponível");
        }
        ...
        if(idade < faixaEtaria){
            throw new Exception("Idade menor que a faixa etária");
        }
